      ...
      <Graph>
        <PredictionCards>
          <Heading>
            {loading ? (
              ...
              <>
                ...
                >
                  <path
                    d="M12.236 1.43628H1.76324C1.12059 1.43628 0.599609 1.95725 0.599609 2.59991V15.3999C0.599609 16.0425 1.12059 16.5635 1.76324 16.5635H12.236C12.8786 16.5635 13.3996 16.0425 13.3996 15.3999V2.59991C13.3996 1.95725 12.8786 1.43628 12.236 1.43628Z"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M3.79872 10.7454C3.63806 10.7454 3.50781 10.6151 3.50781 10.4545C3.50781 10.2938 3.63806 10.1636 3.79872 10.1636"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M3.79883 10.7454C3.95949 10.7454 4.08974 10.6151 4.08974 10.4545C4.08974 10.2938 3.95949 10.1636 3.79883 10.1636"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M6.99989 10.7454C6.83923 10.7454 6.70898 10.6151 6.70898 10.4545C6.70898 10.2938 6.83923 10.1636 6.99989 10.1636"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M7 10.7454C7.16066 10.7454 7.29091 10.6151 7.29091 10.4545C7.29091 10.2938 7.16066 10.1636 7 10.1636"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M10.1991 10.7454C10.0384 10.7454 9.9082 10.6151 9.9082 10.4545C9.9082 10.2938 10.0384 10.1636 10.1991 10.1636"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M10.1992 10.7454C10.3599 10.7454 10.4901 10.6151 10.4901 10.4545C10.4901 10.2938 10.3599 10.1636 10.1992 10.1636"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M3.79872 13.6546C3.63806 13.6546 3.50781 13.5244 3.50781 13.3637C3.50781 13.203 3.63806 13.0728 3.79872 13.0728"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M3.79883 13.6546C3.95949 13.6546 4.08974 13.5244 4.08974 13.3637C4.08974 13.203 3.95949 13.0728 3.79883 13.0728"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M6.99989 13.6546C6.83923 13.6546 6.70898 13.5244 6.70898 13.3637C6.70898 13.203 6.83923 13.0728 6.99989 13.0728"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M7 13.6546C7.16066 13.6546 7.29091 13.5244 7.29091 13.3637C7.29091 13.203 7.16066 13.0728 7 13.0728"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M10.1991 13.6546C10.0384 13.6546 9.9082 13.5244 9.9082 13.3637C9.9082 13.203 10.0384 13.0728 10.1991 13.0728"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M10.1992 13.6546C10.3599 13.6546 10.4901 13.5244 10.4901 13.3637C10.4901 13.203 10.3599 13.0728 10.1992 13.0728"
                    stroke="white"
                    strokeWidth="1.0505"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <Cryptoselect>
            ...
            {loading ? (
              <SkeletonWrapper isLoading={loading} height={48} width={775} />
            ) : (
            ...
            <Field>
              ...
              {loading ? (
                ...
                <InputDropDown
                  ...
                  options={[
                    { label: <Divi>1 Day</Divi>, value: "1" },
                    { label: <Divi>1 Week</Divi>, value: "7" },
                    { label: <Divi>1 Month</Divi>, value: "30" },
                    { label: <Divi>1 Year</Divi>, value: "365" },
                  ]}
                  placeholder={<Divi>Select TimeFrame</Divi>}
                  rowHeight={44}
                  search={{
                    onChange: () => {},
                    onClear: () => {},
          ...
          {loading ? (
            ...
            <Component15b>
              <Frame458>
                ...
                <Wcontent>
                  All price predictions are based on research model and is in
                  continuous development. ZebPay does not hold responsible for
                  any price prediction accuracy and is purely based for research
                  purposes.
                </Wcontent>
              </Frame458>
            </Component15b>
